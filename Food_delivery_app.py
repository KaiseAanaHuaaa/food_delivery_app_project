...
# print(register_user("users.json","kar","0054",21,82232121))
# print(register_user("users.json","sumit","0376",32,65482524126))
                ...
                for j in range(len(content)):
                    if content[j]["id"] == user_id:
                        ...
                        if date not in content[j]["order history"]:
                            ...
                            content[j]["order history"][date].append(
                                content1[i]["name"])
                            flag = 1
                            count = count+1
                            food_price = content1[i]["price"]*quantity
                        ...
                        if content[i]["password"] == password:
                            while True:
                                ...
                                if val3 == "1":
                                    ...
                                    user_place_order(
                                        "user.json", "food.json", user_id, food_name, quantity)
                                elif val3 == "3":
